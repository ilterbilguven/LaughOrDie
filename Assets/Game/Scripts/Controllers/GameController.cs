...
namespace Game.Scripts.Controllers
{
    public class GameController : MonoBehaviour
    {
        ...
        private Coroutine _blackenCoroutine;
        ...
        public void EndGame(bool win)
        {
            ...
            _blackenCoroutine = StartCoroutine(BlackenCoroutine());
        ...
        void OnDestroy()
        {
            ...
            if (_blackenCoroutine != null)
            {
                StopCoroutine(_blackenCoroutine);
                _blackenCoroutine = null;
            }
        }
    }
}
